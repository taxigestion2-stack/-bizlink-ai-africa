      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            size="sm"
            disabled={isPending}
            onClick={() => generate(currentMonthRange().start, currentMonthRange().end)}
          >
            📅 Ce mois-ci
          </Button>
          <Button
            ...
            size="sm"
            disabled={isPending}
            onClick={() => generate(defaultPreviousMonthRange().start, defaultPreviousMonthRange().end)}
          >
            📅 Le mois dernier
          </Button>
          <Button
            ...
            size="sm"
            disabled={isPending}
            onClick={() => generate(currentYearRange().start, currentYearRange().end)}
          >
            🗓️ Cette année
          </Button>
          <Button
            ...
            size="sm"
            disabled={isPending}
            onClick={() => generate(previousYearRange().start, previousYearRange().end)}
          >
            🗓️ L'année dernière
          </Button>
        </div>

...
/**
 * Active un abonnement suite à un paiement confirmé (paid), qu'il vienne
 * d'un webhook automatique ou d'une validation manuelle de preuve de
 * paiement — même logique dans les deux cas : plan, parrainage, affiliation.
 */

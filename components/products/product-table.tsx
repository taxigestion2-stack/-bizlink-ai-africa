              ...
              <tr key={product.id} className="border-t">
                ...
                <td className="p-3">
                  <span
                    className={
                      isLow
                        ? 'inline-flex items-center rounded-full bg-red-100 px-2 py-0.5 text-xs text-red-700'
                        : 'inline-flex items-center rounded-full bg-green-100 px-2 py-0.5 text-xs text-green-700'
                    }
                  >
